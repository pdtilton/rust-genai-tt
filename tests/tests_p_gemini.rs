...
#[tokio::test]
async fn g_test_chat_simple_ok() -> Result<()> {
	common_tests::common_test_chat_simple_ok(MODEL, None).await
}

#[tokio::test]
async fn g_test_chat_multi_system_ok() -> Result<()> {
	common_tests::common_test_chat_multi_system_ok(MODEL).await
}

#[tokio::test]
async fn g_test_chat_json_structured_ok() -> Result<()> {
	common_tests::common_test_chat_json_structured_ok(MODEL, Some(Check::USAGE)).await
}

#[tokio::test]
async fn g_test_chat_temperature_ok() -> Result<()> {
	common_tests::common_test_chat_temperature_ok(MODEL).await
}

#[tokio::test]
async fn g_test_chat_stop_sequences_ok() -> Result<()> {
...
#[tokio::test]
async fn g_test_chat_stream_simple_ok() -> Result<()> {
	common_tests::common_test_chat_stream_simple_ok(MODEL, None).await
}

#[tokio::test]
async fn g_test_chat_stream_capture_content_ok() -> Result<()> {
	common_tests::common_test_chat_stream_capture_content_ok(MODEL).await
}

#[tokio::test]
async fn g_test_chat_stream_capture_all_ok() -> Result<()> {
...
// #[tokio::test]
// async fn g_test_chat_image_url_ok() -> Result<()> {
// 	common_tests::common_test_chat_image_url_ok(MODEL).await
// }

#[tokio::test]
async fn g_test_chat_image_b64_ok() -> Result<()> {
	common_tests::common_test_chat_image_b64_ok(MODEL).await
}

#[tokio::test]
async fn g_test_chat_response_image_b64_ok() -> Result<()> {
...
#[tokio::test]
async fn g_test_tool_simple_ok() -> Result<()> {
	common_tests::common_test_tool_simple_ok(MODEL, true).await
}

#[tokio::test]
async fn g_test_tool_full_flow_ok() -> Result<()> {
...
#[tokio::test]
async fn g_test_resolver_auth_ok() -> Result<()> {
...
#[tokio::test]
async fn g_test_list_models() -> Result<()> {
...
#[tokio::test]
async fn g_test_safety_settings_ok() -> Result<()> {
	common_tests::common_test_safety_settings_ok(MODEL).await
}
